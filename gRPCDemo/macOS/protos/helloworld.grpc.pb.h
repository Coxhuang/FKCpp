...
class TestServer final {
 public:
  static constexpr char const* service_full_name() {
    return "helloworld.TestServer";
  }
  class StubInterface {
   public:
    virtual ~StubInterface() {}
    virtual ::grpc::Status hello_request(::grpc::ClientContext* context, const ::helloworld::HelloMessage& request, ::helloworld::Reply* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::helloworld::Reply>> Asynchello_request(::grpc::ClientContext* context, const ::helloworld::HelloMessage& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::helloworld::Reply>>(Asynchello_requestRaw(context, request, cq));
    }
    ...
    class experimental_async_interface {
     public:
      ...
      virtual void hello_request(::grpc::ClientContext* context, const ::helloworld::HelloMessage* request, ::helloworld::Reply* response, std::function<void(::grpc::Status)>) = 0;
      virtual void hello_request(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::helloworld::Reply* response, std::function<void(::grpc::Status)>) = 0;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void hello_request(::grpc::ClientContext* context, const ::helloworld::HelloMessage* request, ::helloworld::Reply* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void hello_request(::grpc::ClientContext* context, const ::helloworld::HelloMessage* request, ::helloworld::Reply* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void hello_request(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::helloworld::Reply* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
  ...
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status hello_request(::grpc::ClientContext* context, const ::helloworld::HelloMessage& request, ::helloworld::Reply* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::helloworld::Reply>> Asynchello_request(::grpc::ClientContext* context, const ::helloworld::HelloMessage& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::helloworld::Reply>>(Asynchello_requestRaw(context, request, cq));
    }
    ...
    class experimental_async final :
     ...
     public:
      void hello_request(::grpc::ClientContext* context, const ::helloworld::HelloMessage* request, ::helloworld::Reply* response, std::function<void(::grpc::Status)>) override;
      void hello_request(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::helloworld::Reply* response, std::function<void(::grpc::Status)>) override;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void hello_request(::grpc::ClientContext* context, const ::helloworld::HelloMessage* request, ::helloworld::Reply* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void hello_request(::grpc::ClientContext* context, const ::helloworld::HelloMessage* request, ::helloworld::Reply* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void hello_request(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::helloworld::Reply* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
  ...
  class WithAsyncMethod_hello_request : public BaseClass {
   ...
   public:
    WithAsyncMethod_hello_request() {
      ::grpc::Service::MarkMethodAsync(0);
    }
    ~WithAsyncMethod_hello_request() override {
    ...
    void Requesthello_request(::grpc::ServerContext* context, ::helloworld::HelloMessage* request, ::grpc::ServerAsyncResponseWriter< ::helloworld::Reply>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
  ...
  class ExperimentalWithCallbackMethod_hello_request : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithCallbackMethod_hello_request() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
    ...
    #endif
                     context, const ::helloworld::HelloMessage* request, ::helloworld::Reply* response) { return this->hello_request(context, request, response); }));}
    void SetMessageAllocatorFor_hello_request(
    ...
    ~ExperimentalWithCallbackMethod_hello_request() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status hello_request(::grpc::ServerContext* /*context*/, const ::helloworld::HelloMessage* /*request*/, ::helloworld::Reply* /*response*/) override {
    ...
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
    virtual ::grpc::ServerUnaryReactor* hello_request(
      ::grpc::CallbackServerContext* /*context*/, const ::helloworld::HelloMessage* /*request*/, ::helloworld::Reply* /*response*/)
    #else
    virtual ::grpc::experimental::ServerUnaryReactor* hello_request(
  ...
  class WithGenericMethod_hello_request : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithGenericMethod_hello_request() {
      ::grpc::Service::MarkMethodGeneric(0);
    }
    ~WithGenericMethod_hello_request() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status hello_request(::grpc::ServerContext* /*context*/, const ::helloworld::HelloMessage* /*request*/, ::helloworld::Reply* /*response*/) override {
  ...
  template <class BaseClass>
  class WithRawMethod_hello_request : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawMethod_hello_request() {
      ::grpc::Service::MarkMethodRaw(0);
    }
    ~WithRawMethod_hello_request() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status hello_request(::grpc::ServerContext* /*context*/, const ::helloworld::HelloMessage* /*request*/, ::helloworld::Reply* /*response*/) override {
  ...
  template <class BaseClass>
  class ExperimentalWithRawCallbackMethod_hello_request : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithRawCallbackMethod_hello_request() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
        ...
        MarkMethodRawCallback(0,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ...
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->hello_request(context, request, response); }));
    }
    ~ExperimentalWithRawCallbackMethod_hello_request() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status hello_request(::grpc::ServerContext* /*context*/, const ::helloworld::HelloMessage* /*request*/, ::helloworld::Reply* /*response*/) override {
  ...
  class WithStreamedUnaryMethod_hello_request : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithStreamedUnaryMethod_hello_request() {
            ...
            [this](::grpc_impl::ServerContext* context,
                   ::grpc_impl::ServerUnaryStreamer<
                     ::helloworld::HelloMessage, ::helloworld::Reply>* streamer) {
                       return this->Streamedhello_request(context,
                         streamer);
                  }));
    }
    ~WithStreamedUnaryMethod_hello_request() override {
      BaseClassMustBeDerivedFromService(this);
    }
