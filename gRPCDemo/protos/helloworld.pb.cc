...
static void InitDefaultsscc_info_HelloMessage_helloworld_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::helloworld::_HelloMessage_default_instance_;
    new (ptr) ::helloworld::HelloMessage();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::helloworld::HelloMessage::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_HelloMessage_helloworld_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_HelloMessage_helloworld_2eproto}, {}};
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_helloworld_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::helloworld::Reply, result_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::helloworld::HelloMessage, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::helloworld::HelloMessage, a_),
  PROTOBUF_FIELD_OFFSET(::helloworld::HelloMessage, b_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::helloworld::Reply)},
  { 6, -1, sizeof(::helloworld::HelloMessage)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::helloworld::_Reply_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::helloworld::_HelloMessage_default_instance_),
};
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_helloworld_2eproto_sccs[2] = {
  &scc_info_HelloMessage_helloworld_2eproto.base,
...
Reply::Reply(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:helloworld.Reply)
}
...
const HelloMessage& HelloMessage::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_HelloMessage_helloworld_2eproto.base);
  return *internal_default_instance();
}
...
// @@protoc_insertion_point(generalized_merge_from_start:helloworld.HelloMessage)
  GOOGLE_DCHECK_NE(&from, this);
  const HelloMessage* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<HelloMessage>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:helloworld.HelloMessage)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:helloworld.HelloMessage)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:helloworld.HelloMessage)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::helloworld::Reply* Arena::CreateMaybeMessage< ::helloworld::Reply >(Arena* arena) {
  return Arena::CreateMessageInternal< ::helloworld::Reply >(arena);
}
template<> PROTOBUF_NOINLINE ::helloworld::HelloMessage* Arena::CreateMaybeMessage< ::helloworld::HelloMessage >(Arena* arena) {
  return Arena::CreateMessageInternal< ::helloworld::HelloMessage >(arena);
}
